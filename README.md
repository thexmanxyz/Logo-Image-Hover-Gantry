...
___
**Default Particle:**
[English](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.particle.only.EN.v1.2.1.zip) / [German](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.particle.only.DE.v1.2.1.zip)

**Legacy Particle - Gantry <5.3.2:**
[English](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.particle.only.legacy.EN.v1.2.1.zip) / [German](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.particle.only.legacy.DE.v1.2.1.zip)

**Joomla Plugin - All Templates (Global):**
[English](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.j3.global.EN.v1.2.1.zip) / [German](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.j3.global.DE.v1.2.1.zip)

**Joomla Plugin - Hydrogen:**
[English](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.j3.hydrogen.EN.v1.2.1.zip) / [German](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.j3.hydrogen.DE.v1.2.1.zip)

**Joomla Plugin - Helium:**
[English](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.j3.helium.EN.v1.2.1.zip) / [German](https://github.com/thexmanxyz/Logo-Image-Hover-Gantry/releases/download/v1.2.1/lih.j3.helium.DE.v1.2.1.zip)
___
